...
[[sec:khr-includes-header-files]]
== Header files

The header files provided by this extension are located in the
[code]#<sycl/khr/includes># directory.

[[sec:khr-includes-feature-test]]
== Feature test macro

An implementation supporting this extension must predefine the macro
[code]#SYCL_KHR_INCLUDES# to one of the values defined in the table below.
...
objects, but [code]#<sycl/khr/includes/queue.hpp># is not required to provide a
...
[[sec:khr-includes-builtins-math]]
=== [code]#<sycl/khr/includes/builtins_math.hpp># header
...
[[sec:khr-includes-builtins-integer]]
=== [code]#<sycl/khr/includes/builtins_integer.hpp># header

This header includes all SYCL built-in functions documented by
<<sec:integer-functions>>.

[[sec:khr-includes-builtins-common]]
=== [code]#<sycl/khr/includes/builtins_common.hpp># header

This header includes all SYCL built-in functions documented by
<<sec:common-functions>>.

[[sec:khr-includes-builtins-geometric]]
=== [code]#<sycl/khr/includes/builtins_geometric.hpp># header

This header includes all SYCL built-in functions documented by
<<sec:geometric-functions>>.

[[sec:khr-includes-builtins-relational]]
=== [code]#<sycl/khr/includes/builtins_relational.hpp># header
