...
[.remark]#_Remarks:_ Template parameter to [code]#device::get_info#.#

[.constraints]#_Constraints:_ Available only when [code]#Dimensions# is 1, 2 or 3.#

[.return]#_Returns:_ The maximum number of work-groups that can be submitted in each dimension of an [code]#nd_range<Dimensions>#. The minimum value is 1 in each dimension if the device is not [code]#info::device_type::custom#.#
