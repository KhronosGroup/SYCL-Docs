...
[[sec:khr-work-item-queries-header-files]]
== Header files
...
header [code]#<sycl/khr/work_item_queries.hpp>#, and the feature test macro is
additionally provided by [code]#<sycl/khr/split_headers/version.hpp>#.
