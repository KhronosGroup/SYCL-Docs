...
_Effects:_ Enqueues a prefetch host of [code]#num_bytes# of data starting at address
...
{note} [code]#prefetch_host# inform the SYCL runtime that the specified shared allocation is
