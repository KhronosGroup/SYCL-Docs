...
_Returns:_ The total maximum number of work-groups that can be submitted to an ND-range kernel. The minimum value is 1 if the device is not [api]#info::device_type::custom#.
