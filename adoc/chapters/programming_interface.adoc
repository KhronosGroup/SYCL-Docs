...
** (If [code]#NonScalar1# is [code]#marray#): A {cpp} cv-unqualified pointer to
   [code]#marray# of [code]#int# with the same number of elements as
   [code]#NonScalar1#; or
** (If [code]#NonScalar1# is [code]#vec# or the [code]#+__swizzle__+#
...
* If [code]#GenInt1# is [code]#vec# or the [code]#+__swizzle__+# type, then
  [code]#GenInt2# must also be [code]#vec# or the [code]#+__swizzle__+#
...
* If [code]#GenInt1# is [code]#vec# or the [code]#+__swizzle__+# type, then
  ...
  [code]#+__swizzle__+# type, and all three must have the same element type
...
* If [code]#GeoFloat1# is [code]#vec# or the [code]#+__swizzle__+# type,
...
When [code]#x# is [code]#vec# or the [code]#+__swizzle__+# type, returns
...
* If [code]#GenType1# is not [code]#vec# or the [code]#+__swizzle__+# type,
...
** [code]#NonScalar2# must also be [code]#vec# or the [code]#+__swizzle__+#
   type, and both must have the same element type and the same number of
   elements; and
** [code]#NonScalar3# must be [code]#vec# or the [code]#+__swizzle__+# type
