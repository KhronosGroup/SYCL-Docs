...
and attempt to access an element produces undefined behaviour.
====
...
If the range is zero sized, this constructs an empty accessor which fulfills the
...
If the range is zero sized, this constructs an empty host accessor which fulfills the
following post-conditions:
--
  * [code]#(empty() == true)#
  * All size queries return [code]#0#.
...
If the range is zero sized, this constructs an empty local accessor which fulfills the
following post-conditions:
--
  * [code]#(empty() == true)#
  * All size queries return [code]#0#.
