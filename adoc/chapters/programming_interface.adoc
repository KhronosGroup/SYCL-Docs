...
Any usage of the [code]#enum class backend# should appear only in code paths
specialized for a specific <<backend>> that are guarded by a preprocessor
directive using the macro associated with that backend.
