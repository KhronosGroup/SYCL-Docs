...
_Effects:_ The effect of these functions is the same as if they were called on
a temporary [code]#vec# object that contains the result of the captured swizzle
operation.
