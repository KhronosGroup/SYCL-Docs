...
NOTE: Since the object representation of a [code]#vec<T, 3># contains padding
bits (see <<memory-layout-and-alignment>>), using [code]#as# or
[code]#bit_cast# to create a [code]#vec# with a different number of elements
