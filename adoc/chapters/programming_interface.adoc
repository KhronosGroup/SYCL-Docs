...
----
   a@ Return an instance of the implementation-defined
      ...
      <<swizzled-vec-class>>.
      The [code]#swizzleIndexes# argument pack specifies the elements in the
      swizzle.
...
[code]#vec# object that underlies the view with the swizzle operation applied.
...
represents the combination of two swizzle operations.
...
const __writeable_swizzle__& operator=(const __writeable_swizzle__</*unspecified*/>& rhs) const

template</*unspecified*/>
const __writeable_swizzle__& operator=(const __const_swizzle__</*unspecified*/>& rhs) const
----
!====
_Availability:_ Available only in [code]#+__writeable_swizzle__+#.
...
operatorOP(const __writeable_swizzle__& lhs, const DataT& rhs)

friend vec<DataT, NumElements>                                                          (10)
operatorOP(const __const_swizzle__& lhs, const DataT& rhs)

friend vec<DataT, NumElements>                                                          (11)
operatorOP(const DataT& lhs, const __writeable_swizzle__& rhs)

friend vec<DataT, NumElements>                                                          (12)
operatorOP(const DataT& lhs, const __const_swizzle__& rhs)
----
!====
...
In addition, overloads (1) - (4) are available only when the element data type
...
[code]#+__swizzle__+# type, in which case the return type is the
...
* [code]#NonScalar# is [code]#marray#, [code]#vec#, or the
  [code]#+__swizzle__+# type with element type [code]#float#,
  [code]#double#, or [code]#half#;
* [code]#Ptr# is [code]#multi_ptr# with [code]#ElementType# equal to
  [code]#NonScalar#, unless [code]#NonScalar# is the [code]#+__swizzle__+#
...
** If [code]#NonScalar# is [code]#marray#, [code]#ElementType# is
   ...
   [code]#NonScalar#;
** If [code]#NonScalar# is [code]#vec# or the [code]#+__swizzle__+# type,
...
the [code]#+__swizzle__+# type, the return type is [code]#vec# of
...
* If [code]#GenInt1# is not [code]#vec# or the [code]#+__swizzle__+# type,
  then [code]#GenInt2# must be the same as [code]#GenInt1#; and
* If [code]#GenInt1# is [code]#vec# or the [code]#+__swizzle__+# type,
  then [code]#GenInt2# must also be [code]#vec# or the
  [code]#+__swizzle__+# type, and both must have the same element type and
...
* If [code]#GenInt1# is [code]#vec# or the [code]#+__swizzle__+# type,
  ...
  [code]#+__swizzle__+# type, and all three must have the same element
...
[code]#vec#, or the [code]#+__swizzle__+# type and is a _generic integer
...
* [code]#UInt8Bit1# and [code]#UInt8Bit2# are any combination of [code]#vec# or
  the [code]#+__swizzle__+# type with element type [code]#uint8_t# and the
...
* [code]#Int8Bit# is [code]#vec# or the [code]#+__swizzle__+# type with
  element type [code]#int8_t# and [code]#UInt8Bit# is [code]#vec# or the
  [code]#+__swizzle__+# type with element type [code]#uint8_t# and both
...
* [code]#UInt16Bit1# and [code]#UInt16Bit2# are any combination of [code]#vec#
  or the [code]#+__swizzle__+# type with element type [code]#uint16_t# and
  the same number of elements.
...
* [code]#Int16Bit# is [code]#marray# with element type [code]#int16_t# and
  ...
  both have the same number of elements; or
* [code]#Int16Bit# is [code]#vec# or the [code]#+__swizzle__+# type with
  element type [code]#int16_t# and [code]#UInt16Bit# is [code]#vec# or the
  [code]#+__swizzle__+# type with element type [code]#uint16_t# and both
  have the same number of elements.
...
* [code]#UInt32Bit1# and [code]#UInt32Bit2# are any combination of [code]#vec#
  or the [code]#+__swizzle__+# type with element type [code]#uint32_t# and
  the same number of elements.
...
* [code]#Int32Bit# is [code]#marray# with element type [code]#int32_t# and
  ...
  both have the same number of elements; or
* [code]#Int32Bit# is [code]#vec# or the [code]#+__swizzle__+# type with
  element type [code]#int32_t# and [code]#UInt32Bit# is [code]#vec# or the
  [code]#+__swizzle__+# type with element type [code]#uint32_t# and both
  have the same number of elements.
...
** [code]#+__swizzle__+# that is convertible to [code]#vec<int32_t, N>#
** [code]#+__swizzle__+# that is convertible to [code]#vec<uint32_t, N>#
* If [code]#Int32Bit1# is not [code]#vec# or the [code]#+__swizzle__+#
  type, then [code]#Int32Bit2# and [code]#Int32Bit# must be the same as
  [code]#Int32Bit1#; and
* If [code]#Int32Bit1# is [code]#vec# or the [code]#+__swizzle__+# type,
...
* If [code]#GenFloat1# is not [code]#vec# or the [code]#+__swizzle__+#
  type, then [code]#GenFloat2# and [code]#GenFloat3# must be the same as
  [code]#GenFloat1#; and
* If [code]#GenFloat1# is [code]#vec# or the [code]#+__swizzle__+# type,
...
_Constraints:_ Available only if [code]#NonScalar# is [code]#marray#,
[code]#vec#, or the [code]#+__swizzle__+# type and is a _generic floating
...
* If [code]#Geo3or4Float1# is [code]#vec# or the [code]#+__swizzle__+#
...
* If [code]#GeoFloat1# is not [code]#vec# or the [code]#+__swizzle__+#
  type, then [code]#GeoFloat2# must be the same as [code]#GeoFloat1#; and
* If [code]#GeoFloat1# is [code]#vec# or the [code]#+__swizzle__+#
...
* If [code]#GeoFloat1# is [code]#vec# or the [code]#+__swizzle__+#
  type, then [code]#GeoFloat2# must also be [code]#vec# or the
  [code]#+__swizzle__+# type, and both must have the same number of
  elements.
...
[code]#NonScalar1# is [code]#vec# or the [code]#+__swizzle__+# type,
...
[code]#+__swizzle__+# type, returns the value
...
[code]#NonScalar# is [code]#vec# or the [code]#+__swizzle__+# type,
...
[code]#+__swizzle__+# type, returns the value 1 if any element in
...
[code]#+__swizzle__+# type, returns the value 1 if all elements in
...
* If [code]#GenType1# is not [code]#vec# or the [code]#+__swizzle__+#
  type, then [code]#GenType2# and [code]#GenType3# must be the same as
  [code]#GenType1#; and
* If [code]#GenType1# is [code]#vec# or the [code]#+__swizzle__+# type,
...
** [code]#NonScalar2# must also be [code]#vec# or the
   [code]#+__swizzle__+# type, and both must have the same element type
   and the same number of elements; and
** [code]#NonScalar3# must be [code]#vec# or the [code]#+__swizzle__+#
