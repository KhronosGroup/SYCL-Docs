...
_Returns:_ A [code]#std::vector# of [code]#std::size_t# containing the set of
...
* [code]#int4# ([code]#vec<std::int32_t,4>#),
* [code]#uint4# ([code]#vec<std::uint32_t,4>#),
...
The second way is by passing a single [code]#std::size_t# value to multiple
...
take a [code]#std::size_t# parameter defined by this accessor class that are
...
is the cast to [code]#std::size_t#.

a@
[source]
----
range operatorOP(const range& lhs, const std::size_t& rhs)
----
   a@ Where [code]#OP# is: [code]#pass:[+]#, [code]#-#, [code]#*#,
      [code]#/#, [code]#%#, [code]#<<#, [code]#>>#,
      [code]#&#, [code]#|#, [code]#^#,
...
[source]
----
range& operatorOP(range& lhs, const std::size_t& rhs)
----
   a@ Where [code]#OP# is: [code]#pass:[+=]#, [code]#-=#,[code]#*=#, [code]#/=#, [code]#%=#, [code]#+<<=+#, [code]#>>=#, [code]#&=#, [code]#|=#, [code]#^=#.
...
[source]
----
range operatorOP(const std::size_t& lhs, const range& rhs)
----
   a@ Where [code]#OP# is: [code]#pass:[+]#, [code]#-#, [code]#*#,
      [code]#/#, [code]#%#, [code]#<<#, [code]#>>#,
      [code]#&#, [code]#|#, [code]#^#,
...
[source]
----
id operatorOP(const id& lhs, const std::size_t& rhs)
----
   a@ Where [code]#OP# is: [code]#pass:[+]#, [code]#-#, [code]#*#, [code]#/#, [code]#%#, [code]#<<#, [code]#>>#,
      [code]#&#, [code]#|#, [code]#^#, [code]#&&#, [code]#||#, [code]#<#, [code]#>#, [code]#+<=+#, [code]#>=#.
...
[source]
----
id& operatorOP(id& lhs, const std::size_t& rhs)
----
   a@ Where [code]#OP# is: [code]#pass:[+=]#, [code]#-=#,[code]#*=#, [code]#/=#, [code]#%=#,
      [code]#+<<=+#, [code]#>>=#, [code]#&=#, [code]#|=#, [code]#^=#.
...
[source]
----
id operatorOP(const std::size_t& lhs, const id& rhs)
----
   a@ Where [code]#OP# is: [code]#pass:[+]#, [code]#-#, [code]#*#, [code]#/#, [code]#%#, [code]#<<#, [code]#>>#,
      [code]#&#, [code]#|#, [code]#^#, [code]#&&#, [code]#||#, [code]#<#, [code]#>#, [code]#+<=+#, [code]#>=#.
...
----
   a@ Defines and invokes a <<sycl-kernel-function>> as a lambda expression
      ...
      [code]#std::size_t)#, if range is 1-dimensional, for indexing in the indexing
...
----
   a@ Deprecated in SYCL 2020.
      ...
      (e.g [code]#int#, [code]#std::size_t)#, if range is 1-dimensional,
...
[code]#int# or [code]#std::size_t#) because a 1-D [code]#item# is implicitly
...
If [code]#sizeof(DataT)# is 1, [code]#RET# is [code]#std::int8_t#.
If [code]#sizeof(DataT)# is 2, [code]#RET# is [code]#std::int16_t#.
If [code]#sizeof(DataT)# is 4, [code]#RET# is [code]#std::int32_t#.
If [code]#sizeof(DataT)# is 8, [code]#RET# is [code]#std::int64_t#.
...
integral types are [code]#char# and [code]#std::int8_t#, [code]#uchar# and
[code]#std::uint8_t#, [code]#short# and [code]#std::int16_t#, [code]#ushort# and
[code]#std::uint16_t#, [code]#int# and [code]#std::int32_t#, [code]#uint# and
[code]#std::uint32_t#, [code]#long# and [code]#std::int64_t#, [code]#ulong# and
[code]#std::uint64_t#, and for floating point types are both [code]#half#,
[code]#float# and [code]#double#.

For example [code]#uint4# is the alias to [code]#vec<std::uint32_t, 4># and
...
[code]#std::uint16_t#, [code]#int# and [code]#std::int32_t#, [code]#uint# and
[code]#std::uint32_t#, [code]#long# and [code]#std::int64_t#, [code]#ulong# and
[code]#std::uint64_t#, for floating point types are both [code]#half#,
[code]#float# and [code]#double#, and for boolean type [code]#bool#.

For example [code]#muint4# is the alias to [code]#marray<std::uint32_t, 4># and
...
[source]
----
stream(std::size_t totalBufferSize, std::size_t workItemBufferSize, handler& cgh,
       const property_list& propList = {})
----
...
** (If [code]#NonScalar# is [code]#vec# or the [code]#+__swizzle__+# type): A
   {cpp} cv-unqualified pointer to [code]#vec# of [code]#std::int32_t# with the
...
** (If [code]#NonScalar# is [code]#vec# or the [code]#+__swizzle__+# type): A
   ...
   of [code]#std::int32_t# with the same number of elements as
   [code]#NonScalar#.
...
return type is [code]#vec# of [code]#std::int32_t# with the same number of
...
* If [code]#NonScalar1# is [code]#vec# or the [code]#+__swizzle__+# type,
  ...
  [code]#std::int32_t# with the same number of elements as [code]#NonScalar1#.
...
* [code]#NonScalar# is [code]#marray#, [code]#vec#, or the [code]#+__swizzle__+#
  type; and
* The element type is [code]#std::uint32_t#, [code]#std::uint64_t#, or
  [code]#std::uint16_t#.
...
@[code]#marray<std::uint32_t, N># @[code]#marray<float, N>#
@[code]#marray<std::uint64_t, N># @[code]#marray<double, N>#
@[code]#marray<std::uint16_t, N># @[code]#marray<half, N>#

@[code]#vec<std::uint32_t, N># +
 [code]#+__swizzle__+# that is convertible to [code]#vec<std::uint32_t, N>#
@[code]#vec<float, N>#

@[code]#vec<std::uint64_t, N># +
 [code]#+__swizzle__+# that is convertible to [code]#vec<std::uint64_t, N>#
@[code]#vec<double, N>#

@[code]#vec<std::uint16_t, N># +
 [code]#+__swizzle__+# that is convertible to [code]#vec<std::uint16_t, N>#
@[code]#vec<half, N>#
|====
...
* [code]#vec<std::int8_t, N>#
* [code]#vec<std::int16_t, N>#
* [code]#vec<std::int32_t, N>#
* [code]#vec<std::int64_t, N>#
* [code]#vec<std::uint8_t, N>#
* [code]#vec<std::uint16_t, N>#
* [code]#vec<std::uint32_t, N>#
* [code]#vec<std::uint64_t, N>#
* [code]#+__swizzle__+# that is convertible to [code]#vec<std::int8_t, N>#
* [code]#+__swizzle__+# that is convertible to [code]#vec<std::int16_t, N>#
* [code]#+__swizzle__+# that is convertible to [code]#vec<std::int32_t, N>#
* [code]#+__swizzle__+# that is convertible to [code]#vec<std::int64_t, N>#
* [code]#+__swizzle__+# that is convertible to [code]#vec<std::uint8_t, N>#
* [code]#+__swizzle__+# that is convertible to [code]#vec<std::uint16_t, N>#
* [code]#+__swizzle__+# that is convertible to [code]#vec<std::uint32_t, N>#
* [code]#+__swizzle__+# that is convertible to [code]#vec<std::uint64_t, N>#
...
* [code]#UInt8Bit1# and [code]#UInt8Bit2# are both [code]#std::uint8_t#;
* [code]#UInt8Bit1# and [code]#UInt8Bit2# are both [code]#marray# with element
  type [code]#std::uint8_t# and the same number of elements; or
* [code]#UInt8Bit1# and [code]#UInt8Bit2# are any combination of [code]#vec# or
  the [code]#+__swizzle__+# type with element type [code]#std::uint8_t# and the
  same number of elements.

_Returns:_ When the inputs are scalars, returns [code]#((std::uint16_t)hi << 8)
| lo#.
Otherwise, returns [code]#((std::uint16_t)hi[i] << 8) | lo[i]# for each element
of [code]#hi# and [code]#lo#.

The return type is [code]#std::uint16_t# when the inputs are scalar.
When the inputs are [code]#marray#, the return type is [code]#marray# with
element type [code]#std::uint16_t# and the same number of elements as the
inputs.
Otherwise, the return type is [code]#vec# with element type
[code]#std::uint16_t# and the same number of elements as the inputs.
...
* [code]#Int8Bit# is [code]#std::int8_t# and [code]#UInt8Bit# is
  [code]#std::uint8_t#;
* [code]#Int8Bit# is [code]#marray# with element type [code]#std::int8_t# and
  [code]#UInt8Bit# is [code]#marray# with element type [code]#std::uint8_t# and
  both have the same number of elements; or
* [code]#Int8Bit# is [code]#vec# or the [code]#+__swizzle__+# type with element
  type [code]#std::int8_t# and [code]#UInt8Bit# is [code]#vec# or the
  [code]#+__swizzle__+# type with element type [code]#std::uint8_t# and both
  have the same number of elements.

_Returns:_ When the inputs are scalars, returns [code]#((std::int16_t)hi << 8) |
lo#.
Otherwise, returns [code]#((std::int16_t)hi[i] << 8) | lo[i]# for each element
of [code]#hi# and [code]#lo#.

The return type is [code]#std::int16_t# when the inputs are scalar.
When the inputs are [code]#marray#, the return type is [code]#marray# with
element type [code]#std::int16_t# and the same number of elements as the inputs.
Otherwise, the return type is [code]#vec# with element type [code]#std::int16_t#
...
* [code]#UInt16Bit1# and [code]#UInt16Bit2# are both [code]#std::uint16_t#;
* [code]#UInt16Bit1# and [code]#UInt16Bit2# are both [code]#marray# with element
  type [code]#std::uint16_t# and the same number of elements; or
* [code]#UInt16Bit1# and [code]#UInt16Bit2# are any combination of [code]#vec#
  or the [code]#+__swizzle__+# type with element type [code]#std::uint16_t# and
  the same number of elements.

_Returns:_ When the inputs are scalars, returns [code]#((std::uint32_t)hi << 16)
| lo#.
Otherwise, returns [code]#((std::uint32_t)hi[i] << 16) | lo[i]# for each element
of [code]#hi# and [code]#lo#.

The return type is [code]#std::uint32_t# when the inputs are scalar.
When the inputs are [code]#marray#, the return type is [code]#marray# with
element type [code]#std::uint32_t# and the same number of elements as the
inputs.
Otherwise, the return type is [code]#vec# with element type
[code]#std::uint32_t# and the same number of elements as the inputs.
...
* [code]#Int16Bit# is [code]#std::int16_t# and [code]#UInt16Bit# is
  [code]#std::uint16_t#;
* [code]#Int16Bit# is [code]#marray# with element type [code]#std::int16_t# and
  [code]#UInt16Bit# is [code]#marray# with element type [code]#std::uint16_t#
  and both have the same number of elements; or
* [code]#Int16Bit# is [code]#vec# or the [code]#+__swizzle__+# type with element
  type [code]#std::int16_t# and [code]#UInt16Bit# is [code]#vec# or the
  [code]#+__swizzle__+# type with element type [code]#std::uint16_t# and both
  have the same number of elements.

_Returns:_ When the inputs are scalars, returns [code]#((std::int32_t)hi << 16)
| lo#.
Otherwise, returns [code]#((std::int32_t)hi[i] << 16) | lo[i]# for each element
of [code]#hi# and [code]#lo#.

The return type is [code]#std::int32_t# when the inputs are scalar.
When the inputs are [code]#marray#, the return type is [code]#marray# with
element type [code]#std::int32_t# and the same number of elements as the inputs.
Otherwise, the return type is [code]#vec# with element type [code]#std::int32_t#
and the same number of elements as the inputs.
...
* [code]#UInt32Bit1# and [code]#UInt32Bit2# are both [code]#std::uint32_t#;
* [code]#UInt32Bit1# and [code]#UInt32Bit2# are both [code]#marray# with element
  type [code]#std::uint32_t# and the same number of elements; or
* [code]#UInt32Bit1# and [code]#UInt32Bit2# are any combination of [code]#vec#
  or the [code]#+__swizzle__+# type with element type [code]#std::uint32_t# and
  the same number of elements.

_Returns:_ When the inputs are scalars, returns [code]#((std::uint64_t)hi << 32)
| lo#.
Otherwise, returns [code]#((std::uint64_t)hi[i] << 32) | lo[i]# for each element
of [code]#hi# and [code]#lo#.

The return type is [code]#std::uint64_t# when the inputs are scalar.
When the inputs are [code]#marray#, the return type is [code]#marray# with
element type [code]#std::uint64_t# and the same number of elements as the
inputs.
Otherwise, the return type is [code]#vec# with element type
[code]#std::uint64_t# and the same number of elements as the inputs.
...
* [code]#Int32Bit# is [code]#std::int32_t# and [code]#UInt32Bit# is
  [code]#std::uint32_t#;
* [code]#Int32Bit# is [code]#marray# with element type [code]#std::int32_t# and
  [code]#UInt32Bit# is [code]#marray# with element type [code]#std::uint32_t#
  and both have the same number of elements; or
* [code]#Int32Bit# is [code]#vec# or the [code]#+__swizzle__+# type with element
  type [code]#std::int32_t# and [code]#UInt32Bit# is [code]#vec# or the
  [code]#+__swizzle__+# type with element type [code]#std::uint32_t# and both
  have the same number of elements.

_Returns:_ When the inputs are scalars, returns [code]#((std::int64_t)hi << 32)
| lo#.
Otherwise, returns [code]#((std::int64_t)hi[i] << 32) | lo[i]# for each element
of [code]#hi# and [code]#lo#.

The return type is [code]#std::int64_t# when the inputs are scalar.
When the inputs are [code]#marray#, the return type is [code]#marray# with
element type [code]#std::int64_t# and the same number of elements as the inputs.
Otherwise, the return type is [code]#vec# with element type [code]#std::int64_t#
and the same number of elements as the inputs.
...
** [code]#std::int32_t#
** [code]#std::uint32_t#
** [code]#marray<std::int32_t, N>#
** [code]#marray<std::uint32_t, N>#
** [code]#vec<std::int32_t, N>#
** [code]#vec<std::uint32_t, N>#
** [code]#+__swizzle__+# that is convertible to [code]#vec<std::int32_t, N>#
** [code]#+__swizzle__+# that is convertible to [code]#vec<std::uint32_t, N>#
