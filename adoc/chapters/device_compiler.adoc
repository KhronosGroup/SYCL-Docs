...
In order for the SYCL device compiler to correctly compile
<<device-function, device functions>>, all functions in the source file,
whether <<device-function, device functions>> or not, must be syntactically
correct functions according to this specification.
