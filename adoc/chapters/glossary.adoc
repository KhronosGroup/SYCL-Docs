...
[[discarded-statement]]discarded statement::
    ...
    condition. For more context, see <<sec:language.restrictions.kernels>>.
...
[[manifestly-constant-evaluated]]manifestly constant-evaluated expression or conversion::
    ...
    initialization, etc. This is evaluated at compile-time by the compiler. For
    more context, see <<sec:language.restrictions.kernels>>.
