...
This appendix contains the definitions of all the SYCL information
descriptors introduced in <<chapter:sycl-programming-interface>>.
...
The following interface includes all the information descriptors that apply
to kernels as described in <<table.kernel.info>>.
[source,,linenums]
----
